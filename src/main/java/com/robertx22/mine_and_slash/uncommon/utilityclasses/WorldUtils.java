...
public class WorldUtils {
    ...
    public static List<MapAffixData> getAllAffixesThatAffect(
            PlayerMapCap.IPlayerMapData mapdata, EntityLiving entity) {
    ...
    public static BlockPos getSurfaceCenterOfChunk(World world, BlockPos pos) {
    ...
    public static boolean surfaceIsWater(World world, BlockPos pos) {
    ...
    public static BlockPos getSurface(World world, BlockPos pos) {
        ...
        while (world.isAirBlock(pos) || world.getBlockState(pos)
                .getBlock() instanceof BlockLeaves) {
    ...
    public static int getTier(World world, EntityPlayer player) {
