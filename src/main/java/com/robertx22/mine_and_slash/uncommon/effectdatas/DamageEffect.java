...
public class DamageEffect extends EffectData implements IArmorReducable, IPenetrable, IDamageEffect, IElementalResistable, IElementalPenetrable, ICrittable {
    ...
    public DamageEffect(LivingHurtEvent event, EntityLiving source, EntityLiving target,
    ...
    protected void activate() {
        ...
        if (isDmgAllowed()) {
            ...
            dmg += getEventDmg() * ModConfig.Server.NON_MOD_DAMAGE_MULTI;
            ...
            if (dmg > 0 && source instanceof EntityLiving && info.highestDmgElement != null) {

            	EntityLiving player = (EntityLiving) source;
