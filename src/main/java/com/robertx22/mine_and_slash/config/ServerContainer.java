...
public class ServerContainer {
	...
	@Config.Name("Max Item Instability")
	@Config.LangKey("mmorpg.word.")
	@Config.Comment(".")
	public int MAXIMUM_ITEM_INSTABILITY = 500;
	
	@Config.Name("Stat Points Per Level")
	@Config.LangKey("mmorpg.word.")
	@Config.Comment(".")
	public double STAT_POINTS_PER_LEVEL = 1D;
	
	@Config.Name("Talent Points Per Level")
	@Config.LangKey("mmorpg.word.")
	@Config.Comment(".")
	public double TALENT_POINTS_PER_LEVEL = 1.25D;
	
	@Config.Name("Stat Requirements Multi")
	@Config.LangKey("mmorpg.word.")
	@Config.Comment(".")
	public double STAT_REQUIREMENTS_MULTI = 1D;
	
	@Config.LangKey("mmorpg.word")
	@Config.Comment("If false, player will start with no gear")
	public boolean GET_STARTER_ITEMS = true;
	
	@Config.Name("Enable Currency Items Breaking")
	@Config.LangKey("mmorpg.word")
	@Config.Comment("If false, player will start with no gear")
	public boolean ENABLE_CURRENCY_ITEMS_BREAKING_MODIFIED_ITEMS = true;
	
	@Config.Name("Enable Currency items instability")
	@Config.LangKey("mmorpg.word")
	@Config.Comment("If false, player will start with no gear")
	public boolean ENABLE_CURRENCY_ITEMS_INSTABILITY_SYSTEM = true;
	
	@Config.Name("Reset Maps on Load")
	@Config.LangKey("mmorpg.word")
	@Config.Comment(".")
	public boolean RESET_MAP_DIMENSIONS_ON_LOAD = true;
	
	@Config.Name("Disable Death in Maps")
	@Config.LangKey("mmorpg.word")
	@Config.Comment(",")
	public boolean DISABLE_DEATH_IN_MAPS = true;
	
	@Config.Name("Only Repairable in Station")
	@Config.LangKey("mmorpg.word")
	@Config.Comment(".")
	public boolean ONLY_REPAIR_IN_STATION = false;
